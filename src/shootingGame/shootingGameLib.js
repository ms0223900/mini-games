...
import { spawnEnemyFrequency } from './levelConfig'
...
export class ControllableObj extends BasicStaticImgObj {
  ...
  moveEvent() {
    ...
    // document.addEventListener('keyup', this.removeKeyCode)
  }
  removeKeyCode(e) {
    const { keyCode } = e
...
export class Game {
  constructor(canvas, canvasSpec, gameProp) {
    ...
    document.addEventListener('keyup', (e) => this.newGameKeyUpEvent(e))
  }
